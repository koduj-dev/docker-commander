...
// The Containers tab: every running container with what it actually takes
// (cores, bytes, throughput), sortable and filterable. Numbers, not charts —
// the dashboard already shows shares graphically; this answers "how much,
// exactly". Figures are the monitor sampler's snapshot (see Resources).
export function ContainersTab({ data }: { data: ResourceOverview }) {
