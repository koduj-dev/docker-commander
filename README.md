...
**Control**
- Containers: **create/run**, start/stop/restart/pause/unpause, **rename**, **update** limits & restart policy, **commit** to an image, and an interactive **shell** (xterm.js). (`kill` exists in the API but has no button yet.)
