...
// dialSSH opens an SSH connection to the host, enforcing our host-key trust
// policy. It is shared by the Docker client transport and the port prober.
func dialSSH(h *store.Host) (*ssh.Client, error) {
